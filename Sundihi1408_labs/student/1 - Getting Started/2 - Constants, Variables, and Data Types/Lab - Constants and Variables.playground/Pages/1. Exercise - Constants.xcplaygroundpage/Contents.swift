...
print("The above code doesn't compile because you cannot update the value of a constant once it is declared, if you want to create a value that needs to be updated frequently, you should consider using variable")
/*:
