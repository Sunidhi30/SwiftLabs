...
var favoriteBook = Book(title: "Wonderland", author: "William", pages: 300, price: 50)

print("My fav book is \(favoriteBook.title), its written by \(favoriteBook.author). It consists of \(favoriteBook.pages) pages, its price is \(favoriteBook.price)")
/*:
...
struct Laptop {
    ...
    var repaiCount : Int = 0
    var yearPurchased : Int
}

var lap1 = Laptop(yearPurchased: 2019)
var lap2 = Laptop(yearPurchased: 2021)
/*:
